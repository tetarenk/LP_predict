...
INPUT: (1) sim_start: proposed start date 
       ...
       (optional) Calibrator list for SCUBA-2, HARP, and Pointing
...
for i in range(0,len(bands)):
    ...
    ax.set_xlabel('${\\rm \\bf LST}$',fontsize=12,pad=20)
...
p4=ax.bar(ind,wbtally_vals['Cal'],width,bottom=wbtally_vals['UsedTime']+wbtally_vals['UnusedTime'],color='m',edgecolor='k',lw=1.2)
ax.set_xticks(ind)
